import { ChapterData, DirectoryFilter, DirectoryRequest, PagedResult } from "@suwatte/daisuke";
import { TachiSource } from "./Source";
export declare abstract class TachiCatalogSource extends TachiSource {
